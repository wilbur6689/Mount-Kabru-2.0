...
public enum Suffix {
    ...
    Suffix(String name, Integer strengthValue, Integer manaValue, Integer attackValue, Integer spellAttackValue, Integer healthValue, Integer defenseValue, Integer sellValue) {
        this.name = name;
